...
def topleft_label() :
    l = Label(text = "", halign='left', valign='top', font_size='25sp',
...
def name_label() :
    l = Label(text = "", halign='left', valign='top', font_size='45sp',
              pos=(Window.width * 0.5, Window.height * 0.38),
              text_size=(Window.width, Window.height), markup=True)
    return l
